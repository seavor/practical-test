angular.module("app").run([ "$templateCache", function($templateCache) {
    "use strict";
    $templateCache.put("templates/directives/footer.html", "<ul class=footer-icons><li><a class=footer-icons-facebook href=#></a></li><li><a class=footer-icons-twitter href=#></a></li><li><a class=footer-icons-instagram href=#></a></li></ul><ul class=footer-info><li>101 State Street</li><li>La Crosse, WI 54601</li><li>1-866-697-7300</li><li>sign up for emails</li></ul>");
    ...
    $templateCache.put("templates/directives/master-wrapper.html", "<div class=master-wrapper><div class=page-background style=\"background-image: url({{model.SLIDES[0].IMAGE || 'images/home.jpg'}})\"></div><div class=page-content cornered-border><header></header><div class=view-content ng-transclude></div><footer></footer></div></div>");
